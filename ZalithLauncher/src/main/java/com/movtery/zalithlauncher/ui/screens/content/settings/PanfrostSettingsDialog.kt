...
@Composable
fun PanfrostSettingsDialog(onDismissRequest: () -> Unit) {
    val config = remember { PanfrostConfig.load() ?: PanfrostConfig() }
    ...
    Dialog(onDismissRequest = onDismissRequest) {
        Surface(modifier = Modifier.padding(16.dp).fillMaxWidth(),
            ...
            Column(modifier = Modifier.padding(20.dp).verticalScroll(rememberScrollState()),
                ...
                Text("Panfrost Settings", style = MaterialTheme.typography.titleLarge)
                HorizontalDivider()
