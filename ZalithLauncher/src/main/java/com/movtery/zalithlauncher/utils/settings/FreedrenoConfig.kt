...
class FreedrenoConfig private constructor(private var isInitializing: Boolean) {
    ...
    companion object {
        val CONFIG_FILE_PATH: String
            get() = "${Environment.getExternalStorageDirectory().absolutePath}/FreedrenoConfig/config.json"

        fun load(): FreedrenoConfig? {
            ...
            return runCatching {
                ...
                val cfg = FreedrenoConfig(isInitializing = true)
